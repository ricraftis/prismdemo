...
// We use Gemini 3.1 Flash as it is the most efficient for this logic
...
export async function POST(req: Request) {
  ...
  try {
    ...
    return new Response(JSON.stringify({ error: "Capacity Wall Hit. Try again in 60s." }), { status: 503 });
  }
}
